...
declare const DEV_SERVER_MODE_EVENT = "custom:dev-server-mode";
declare const BOOT_PROGRESS_EVENT = "custom:boot-progress";
declare const UPDATE_PROGRESS_EVENT = "custom:update-progress";
...
declare const FULL_RELOAD_ENV_VAR = "custom_HMR_FULL_RELOAD";
interface HmrGateOptions {
  /** Use full-reload (default) vs granular per-module HMR. Unset reads
   * `custom_HMR_FULL_RELOAD`, where only "false" selects granular. */
  fullReload?: boolean;
