 ...
 */
declare function customAssetsProxyPlugin(): Plugin;
//#endregion
...
interface customViteTanstackOptions {
   ...
   *
   * Inside a custom build `custom_NITRO_PRESET` (Cloudflare by default) pins
  ...
  /** Options forwarded to tanstackStart(). Inside a custom build the prerender output shape is pinned. */
...
declare function defineConfig(options?: customViteTanstackOptions): (env: ConfigEnv) => Promise<UserConfig>;
//#endregion
export { customViteTanstackOptions, type PrerenderPage, defineConfig, customAssetsProxyPlugin, stripRedundantNodejsCompatFlag };
